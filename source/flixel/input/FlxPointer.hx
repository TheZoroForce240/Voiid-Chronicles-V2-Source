...
class FlxPointer
{
	...
	var _gameMouseX:Float = 0.0;
	var _gameMouseY:Float = 0.0;
	...
	public inline function setGlobalScreenPositionUnsafe(newX:Float, newY:Float):Void
	{
		_gameMouseX = newX;
		_gameMouseY = newY;
		_globalScreenX = Std.int(_gameMouseX / FlxG.scaleMode.scale.x);
		_globalScreenY = Std.int(_gameMouseY / FlxG.scaleMode.scale.y);
