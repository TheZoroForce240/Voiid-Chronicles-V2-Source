...
class NoteVariables
{
    ...
    public static var Default_Controller_Binds:Array<Array<String>>;
    ...
    public static function init()
    {
        ...
        Default_Controller_Binds = CoolUtil.coolTextFileOfArrays(Paths.txt("mania data/defaultControllerBinds"));
